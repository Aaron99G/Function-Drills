...
function faveColorFinder (color) {
  if(color === "red" || color === "Red") {
    ...
    return "Green is a solid favorite color too."
...
let oddChecker = thatsOdd(120);
console.log(oddChecker);

oddChecker = thatsOdd(11);
console.log(oddChecker);
...
let newARR = theEliminator(contestants,loser);
console.log(newARR);
...
//CODE HERE
function chocolateFrogs(money) {
  let change = money % 3;
  let amountSpent = money - change;
  let totalChocFrogs = amountSpent / 3;
  return totalChocFrogs;
}
...
//CODE HERE
function chocolateFrogs2(money) {
  let change = money % 3;
  let amountSpent = money - change;
  let totalChocFrogs = amountSpent / 3;
  return totalChocFrogs;
}
 let totalFrogs2 = chocolateFrogs2(79);
...
let arrayIsAscending = ascendingUp(sampleArray);
